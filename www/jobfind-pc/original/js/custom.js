...
exports.default = {
  tagImgs: document.querySelectorAll('img'),
  navBtn: document.querySelector('.js-navBtn'),
  goBack: document.getElementsByClassName('js-backToTop')[0],
  footer: document.getElementById('footer'),
  space: document.querySelector('div.space'),
  container: document.getElementById('container'),
  contents: document.getElementById('contents'),
  carousel: document.querySelector('.carousel'),
  bottomContent: document.getElementById('bottomContent'),
  areaLink: document.getElementById('areaLink'),
  select: document.getElementById('areaSelect'),
  gNav: document.getElementById('nav'),
  header: document.getElementById('header'),
  map: document.getElementById('js-area'),
  hoverImg: document.querySelector('.js-hoverImage')
};
...
var _FixedTop = __webpack_require__(6);

var _FixedTop2 = _interopRequireDefault(_FixedTop);

var _loadSwiper = __webpack_require__(8);

var _loadSwiper2 = _interopRequireDefault(_loadSwiper);
...
(function () {
  ...
  if (window.location.pathname === '/jobfind-pc/') {
    // gNav = new GNavFix()
    swiper = new _loadSwiper2.default();
  }
  var fixedTop = new _FixedTop2.default();
  var fixedTopOpt = {
  ...
  _store2.default.queries.pc.addListener(function () {
    fixedTop.removeFixedTop();
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOpt);
  });

  _store2.default.queries.tab.addListener(function () {
    fixedTop.removeFixedTop();
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOptTb);
  });

  _store2.default.queries.sp.addListener(function () {
    fixedTop.removeFixedTop();
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOptSp);
  });

  _store2.default.queries.spMin.addListener(function () {
    fixedTop.removeFixedTop();
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOptSp);
  });

  if (_store2.default.queries.pc.matches || _store2.default.queries.tab.matches) {
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOpt);
  } else {
    fixedTop.fixedTopInit(_dom2.default.goBack, fixedTopOptSp);
  }
...
var Utilities = function () {
  ...
  _createClass(Utilities, null, [{
    ...
    value: function setImageWidth() {
      var imgs = _dom2.default.tagImgs;
    ...
    key: 'initSpace',
    value: function initSpace() {
      _store2.default.queries.tab.addListener(this.setSpace);
      _store2.default.queries.sp.addListener(this.setSpace);
      _store2.default.queries.spMin.addListener(this.setSpace);
      this.setSpace();
    }
  }, {
    key: 'setSpace',
    value: function setSpace() {
      ...
      if (url.match(/jobfind/)) {
        ...
        if (_dom2.default.contents.scrollHeight < window.innerHeight) {
          this.Log('Set Space');
          // 念の為初期化
          _dom2.default.footer.style.position = '';
          var innerHeight = (arguments.length <= 0 ? undefined : arguments[0]) || 0;
          var footerHight = _dom2.default.footer.clientHeight + innerHeight + 'px';
          this.Log(footerHight);
          // デザイン的にスマホは確実に超えると思われるが念の為。
          if (_store2.default.queries.sp.matches || _store2.default.queries.spMin.matches) {
            _dom2.default.space.style.paddingTop = '0';
          } else {
            _dom2.default.space.style.paddingTop = footerHight;
            _dom2.default.contents.style.height = 'calc(100vh)';
            _dom2.default.footer.style.position = 'absolute';
          }
        } else {
          // コンテンツの高さがウインドウの高さを超える場合、フッターをStaticにする。
          _dom2.default.space.style.paddingTop = '0';
          _dom2.default.footer.style.position = 'static';
        }
      }
    }
  }]);
...
var _fade = __webpack_require__(7);
...
var FixedTop = function () {
  ...
  _createClass(FixedTop, [{
    key: 'fixedTopInit',
    value: function fixedTopInit(target) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

      if (options) {
        this.fixedTopOpt = _extends({}, this.fixedTopOpt, options);
      }
      this.fixedTopOpt.target = target;
      this.targetStyle = target.style;
      this.targetStyle.position = this.targetStyle.position !== 'fixed' ? this.targetStyle.position : 'fixed';
      this.targetStyle.opacity = this.targetStyle.opacity > 0 ? this.targetStyle.opacity : 0;
    ...
    key: 'removeFixedTop',
    value: function removeFixedTop() {
      window.removeEventListener('scroll', this.bindFunctions.bindMain);
    }
  }, {
    key: 'fixedTopMain',
    value: function fixedTopMain() {
      var btm = void 0;
      var alm = void 0;
      var ft = void 0;
      if (this.fixedTopOpt.bottom) {
        btm = _dom2.default.bottomContent.clientHeight; // #bottomContent Height.
      } else {
        btm = 0;
      }
      ...
      if (this.fixedTopOpt.arealink) {
        ...
        if (_dom2.default.areaLink) {
          var mgt = parseInt(_dom2.default.areaLink.style.marginTop, 10);
          var mgb = parseInt(_dom2.default.areaLink.style.marginBottom, 10);
          var areaLinkTop = void 0;
          var areaLinkBtm = void 0;
          if (Number.isNaN(mgt)) {
            areaLinkTop = 0;
          } else {
            areaLinkTop = mgt;
      ...
      if (this.fixedTopOpt.space) {
        ft = _dom2.default.space.clientHeight; // div.space Height.
      } else {
        ft = _dom2.default.footer.clientHeight;
      }

      var fix = btm + ft + alm + this.fixedTopOpt.positionAdjustment; // Bottom Position.
      var d = document.body.scrollHeight; // All Contents Height.
      var c = window.innerHeight; // Window Height.
      var p = d - c - fix + this.fixedTopOpt.stopAdjustment; // Fixed Timing Position.
      var s = window.pageYOffset || document.documentElement.scrollTop; // Scroll Positon Just Now.

      // It's Fade In-Out If Scroll Position Came to Particular Position.
      if (s >= this.fixedTopOpt.fadePosition && !this.fadeFlag) {
        _fade2.default.fadeIn(this.fixedTopOpt.target, this.fixedTopOpt.fadeSpeed);
        this.fadeFlag = true;
      } else if (s <= this.fixedTopOpt.fadePosition && this.fadeFlag) {
        _fade2.default.fadeOut(this.fixedTopOpt.target, this.fixedTopOpt.fadeSpeed);
        this.fadeFlag = false;
      }
      // Position Control.
      if (s >= p) {
    ...
    key: 'initFixedTopOpt',
    value: function initFixedTopOpt() {
      return {
...
exports.default = {
  fadeIn: function fadeIn(target, time) {
    var fadeInTarget = target;
    fadeInTarget.style.opacity = 0;
    var tick = function tick() {
      fadeInTarget.style.opacity = +fadeInTarget.style.opacity + time > 1 ? 1 : +fadeInTarget.style.opacity + time;
  ...
  fadeOut: function fadeOut(target, time) {
    var fadeOutTarget = target;
    fadeOutTarget.style.opacity = 1;
    var tick = function tick() {
      fadeOutTarget.style.opacity = +fadeOutTarget.style.opacity - time < 0 ? 0 : +fadeOutTarget.style.opacity - time;
...
var LoadSwiper = function () {
  function LoadSwiper() {
    _classCallCheck(this, LoadSwiper);

    this.swiperOpt = {};
  }

  _createClass(LoadSwiper, [{
    key: 'initSwiper',
    value: function initSwiper() {
      var className = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.swiper-container';

      return new _swiper2.default(className, this.swiperOpt);
    }
  }, {
    key: 'setSwiperOption',
    value: function setSwiperOption(options) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(10);
